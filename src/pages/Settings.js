...
const LABELS = {
  ...
  syn_flood_warn: 'SYN Flood — แจ้งเตือนเมื่อเกิน (packet/1วิ)',
  syn_flood_block: 'SYN Flood — บล็อกเมื่อเกิน (packet/1วิ)',
  udp_flood_warn: 'UDP Flood — แจ้งเตือนเมื่อเกิน (packet/1วิ)',
  udp_flood_block: 'UDP Flood — บล็อกเมื่อเกิน (packet/1วิ)',
  icmp_flood_warn: 'ICMP Flood — แจ้งเตือนเมื่อเกิน (packet/1วิ)',
  icmp_flood_block: 'ICMP Flood — บล็อกเมื่อเกิน (packet/1วิ)',
